...
function restoreDivisionbyID(id){
    ...
    btnDelele.addEventListener('click' , async (e) => {
        ...
        function restoreDivisionApi(id) {
            const divisionID = "http://134.209.106.33:8888/v1/ordo/restore";
...
const divisionData = "http://134.209.106.33:8888/v1/ordo?deleted=1&page=1";
...
fetch(divisionData,requestOptions)
    .then(function (response){
        ...
        var divisionDataPage = "http://134.209.106.33:8888/v1/ordo?deleted=1&page=" + page;
