...
function addDivision(){
    ...
    fetch("http://134.209.106.33:8888/v1/familia/getByName" + '/' + divisionSuggest, requestOptions)
    .then( function (response) {
...
const divisionData = "http://134.209.106.33:8888/v1/genus?page=1";
var myHeaders = new Headers();
var requestOptions = {
    method: 'GET',
    headers: myHeaders,
...
function editDivisionbyID(id){
        ...
        .then(function (response){     
            ...
            if( data.idHo == undefined){
                getDivisionbyID(data.Ho);
            }
            else{
                getDivisionbyID(data.idHo);
            }
